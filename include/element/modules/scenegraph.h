...
ELM_FUNCTION(scene_get_root_node, element_node_t, element_scene_t)
...
ELM_FUNCTION(node_get_children, uint32_t, element_node_t, element_node_t*)
ELM_FUNCTION(node_get_parent, element_node_t, element_node_t)
